# Adapted from https://github.com/gisodal/gpm/blob/master/Makefile
...
# read project name from projectName file
PROJECT = $(shell cat projectName)
...
SRCS    += $(shell find $(SDIR) -name "*.cc")
OBJS     = $(patsubst $(SDIR)/%.c,$(ODIR)/%.o,$(shell find $(SDIR) -name "*.c"))
OBJS    += $(patsubst $(SDIR)/%.cc,$(ODIR)/%.o,$(shell find $(SDIR) -name "*.cc"))
